...
import com.coopcycle.repository.CustomerRepository;
import com.coopcycle.service.dto.CustomerDTO;
import com.coopcycle.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).age(DEFAULT_AGE).adress(DEFAULT_ADRESS);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).age(UPDATED_AGE).adress(UPDATED_ADRESS);
        return customer;
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).age(UPDATED_AGE).adress(UPDATED_ADRESS);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).age(UPDATED_AGE).adress(UPDATED_ADRESS);
