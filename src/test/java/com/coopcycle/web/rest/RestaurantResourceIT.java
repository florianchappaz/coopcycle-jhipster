...
import com.coopcycle.repository.RestaurantRepository;
import com.coopcycle.service.dto.RestaurantDTO;
import com.coopcycle.service.mapper.RestaurantMapper;
...
class RestaurantResourceIT {
    ...
    private static final Category DEFAULT_CATEGORY = Category.PIZZERIA;
    private static final Category UPDATED_CATEGORY = Category.FASTFOOD;
    ...
    public static Restaurant createEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(DEFAULT_NAME).adress(DEFAULT_ADRESS).category(DEFAULT_CATEGORY);
        return restaurant;
    }
    ...
    public static Restaurant createUpdatedEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(UPDATED_NAME).adress(UPDATED_ADRESS).category(UPDATED_CATEGORY);
        return restaurant;
    }
    ...
    void putNewRestaurant() throws Exception {
        ...
        updatedRestaurant.name(UPDATED_NAME).adress(UPDATED_ADRESS).category(UPDATED_CATEGORY);
    ...
    void fullUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.name(UPDATED_NAME).adress(UPDATED_ADRESS).category(UPDATED_CATEGORY);
