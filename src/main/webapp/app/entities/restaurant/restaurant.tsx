            ...
            <tbody>
              {restaurantList.map((restaurant, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`coopcycleApp.Category.${restaurant.category}`} />
                  </td>
                  <td>{restaurant.city ? <Link to={`city/${restaurant.city.id}`}>{restaurant.city.id}</Link> : ''}</td>
                  <td>
                    {restaurant.cooperative ? <Link to={`cooperative/${restaurant.cooperative.id}`}>{restaurant.cooperative.id}</Link> : ''}
                  </td>
