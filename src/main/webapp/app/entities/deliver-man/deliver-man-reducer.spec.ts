...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DELIVERMAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_DELIVERMAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DELIVERMAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DELIVERMAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DELIVERMAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DELIVERMAN actions', async () => {
      const expectedActions = [
        {
