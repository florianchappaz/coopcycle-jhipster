...
export const ZoneDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="coopcycleApp.zone.delete.question">
        <Translate contentKey="coopcycleApp.zone.delete.question" interpolate={{ id: zoneEntity.id }}>
