...
import com.coopcycle.service.ZoneService;
...
/**
 * REST controller for managing {@link com.coopcycle.domain.Zone}.
 */
@RestController
@RequestMapping("/api")
public class ZoneResource {
     ...
     */
    @GetMapping("/zones")
    public List<ZoneDTO> getAllZones(@RequestParam(required = false) String filter) {
        if ("cooperative-is-null".equals(filter)) {
            log.debug("REST request to get all Zones where cooperative is null");
            return zoneService.findAllWhereCooperativeIsNull();
        }
